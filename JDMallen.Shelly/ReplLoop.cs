...
{
    public static async Task<ReplResult> RunAsync(IChatProvider provider, string? initialPrompt, CancellationToken cancellationToken = default)
    {
        var context = ShellContext.Build();
        ...
        while (true)
        {
            ...
            switch (choice)
            {
                ...
                case ConsoleKey.R:
                    ...
                    var refinement = Console.ReadLine();
